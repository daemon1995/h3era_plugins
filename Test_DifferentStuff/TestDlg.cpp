...
//			//auto pcx = H3DlgPcx16::Create(0, 0, WIDTH, HEIGHT,
// 1323, 0);
//
//		//	H3LoadedPcx16* buf = H3LoadedPcx16::Create(WIDTH,
// HEIGHT);
...
//
//			H3LoadedPcx16* resizedAdagHalfWidth =
// H3LoadedPcx16::Create(WIDTH / 2, HEIGHT);
//
//			DrawPcx16ResizedBicubic(resizedAdagHalfWidth, buf,
// WIDTH, HEIGHT, 0, 0, WIDTH / 2, HEIGHT);
//			pathArrowsPcx16HalfWidth.Push(resizedAdagHalfWidth);
//
//
//			H3LoadedPcx16* resizedAdagWidthX2 =
// H3LoadedPcx16::Create(WIDTH * 2, HEIGHT);
//			DrawPcx16ResizedBicubic(resizedAdagWidthX2, buf, WIDTH,
// HEIGHT, 0, 0, WIDTH * 2, HEIGHT);
...
//
//		{
//			H3LoadedPcx16* srcPcxA =
// H3LoadedPcx16::Load("nhv5_1.pcx"); 			pcxToDraw =
// H3LoadedPcx16::Create(srcPcxA->width, srcPcxA->height);
//
...
//			DrawPcx16ResizedBicubic(pcxToResize, pcxToDraw,
// pcxToDraw->width, pcxToDraw->height, 0, 0, pcxToResize->width,
// pcxToResize->height); 			H3DlgPcx16* pcx;
//
//
//
//			pcx = H3DlgPcx16::Create(0, 0, WIDTHA, HEIGHTA, 1323,
// 0);
//
//
...
//			}
//
//			pcx = H3DlgPcx16::Create(x, y, WIDTH / 2, HEIGHT, 2425
//+ i, 0);
//
//			pcx->SetPcx(pathArrowsPcx16HalfWidth[i]);
//			dlg->AddItem(pcx);
//
//			pcx = H3DlgPcx16::Create(x, _y, WIDTH * 2, HEIGHT, 3425
//+ i, 0);
//
...
//}
// LRESULT CALLBACK MainWindowProc(HiHook* h, HWND hwnd, UINT msg, WPARAM
...
//			// For example, hide the window and show a system tray
// icon
//			// Your code here
//
//			if (!exists)
...
// LoadIcon(GetModuleHandle(NULL), MAKEINTRESOURCE(IDI_APPLICATION)), "My
// Application"); 				CreateSystemTrayIcon(hwnd,
// s.hIcon, "daemon_n learned sth");
//			}
//
//
...
// int __stdcall FooBar(HiHook* h , H3LoadedDef* a1, int a2, int a3, int a4,
...
//		//return THISCALL_14(int,
// h->GetDefaultFunc(),H3LoadedDef::Load("artifact.def"), a2, a3, a4, a5, a6,
// a7, a8, a9, a10, a11, a12, a13, a14);
//
//	}
//
//	return THISCALL_14(int, h->GetDefaultFunc(), a1, a2, a3, a4, a5, a6,
// a7, a8, a9, a10, a11, a12, a13, a14);
//}
