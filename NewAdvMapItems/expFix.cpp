...
int __cdecl sub_7198C1_hook(HiHook* hook, int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
    ...
    if (v10 != -1)
    {
        ...
        {
            sub_7176A1(&dword_860550[4 * v10]);
            dword_860550[4 * v10] = ((long long)a7) *
                ((long long)dword_860550[4 * v10]) /
                ((long long)dword_860554[4 * v10]);
    ...
    if (v9 != -1)
    {
        ...
        if (dword_860554[4 * v9])
        {
            ...
            dword_860550[4 * v9] = ((long long)a8) *
                ((long long)dword_860550[4 * v9]) /
                ((long long)dword_860554[4 * v9]);
...
_LHF_(hook_007662CD) {
    long long result = ((long long)c->eax) +
        (((long long)c->edx) * ((long long)c->ecx));
