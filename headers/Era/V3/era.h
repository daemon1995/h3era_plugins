...
/**	Gives direct access to the e/f/v/x/y/z variables*/
...
ERA_API int32_bool (__stdcall *IsCommanderId) (int32_t MonId);
// ===================== END CREATURES RELATED FUNCTIONS ===================== //
 ...
 */
ERA_API void* (__stdcall *Splice) (void* OrigFunc, void* HandlerFunc, int CallingConv, int NumArgs, int* CustomParam, void** AppliedPatch);
...
ERA_API int (__stdcall *CalcHookPatchSize) (void* pointer);
