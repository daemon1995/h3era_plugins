...
namespace resized
{
	...
	void H3LoadedPcx16Resized::DrawResizedBicubic(H3LoadedPcx16* src_pcx, int s_w, int s_h, int d_x, int d_y, int d_w, int d_h)
	{
	...
	void H3LoadedPcx16Resized::DrawPcx16ResizedBicubic(H3LoadedPcx16* _this, H3LoadedPcx16* src_pcx, const int scale)
	{
		...
		DrawPcx16ResizedBicubic(_this, src_pcx, src_pcx->width, src_pcx->height, 0, 0, src_pcx->width / scale, src_pcx->height / scale);
	}


	void H3LoadedPcx16Resized::DrawPcx16ResizedBicubic(H3LoadedPcx16* _this, H3LoadedPcx16* src_pcx, const int s_w, const int s_h, const int d_x, const int d_y, const int d_w, const int d_h)
	{
