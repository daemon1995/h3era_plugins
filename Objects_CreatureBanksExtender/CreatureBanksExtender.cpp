...
CreatureBanksExtender::CreatureBanksExtender() : IGamePatch(_PI)
{
                                                                ...
                                                                const int picType3, const int picSubtype3)
{
    ...
    {
        finalMessage = H3String::Format("{%s}", GetResolvedObjectName(mapItem->objectType, mapItem->objectSubtype));
    }
