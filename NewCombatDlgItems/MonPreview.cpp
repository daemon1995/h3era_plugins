...
namespace preview
{
	...
	void CreateResources()
	{
		...
		//CreateSmallerPics(spell_int_def.Get(), smaller_spellint, spell_int_def->groups[0]->count, spell_int_def->widthDEF, spell_int_def->heightDEF);
	...
	H3CombatMonsterPanel* __stdcall MonPreview::H3CombatMonsterPanel_Ctor(HiHook* h, H3CombatMonsterPanel* panel, int x, int y, int width, int height, H3BaseDlg* parent, DWORD type)
	{
	...
	MonPreview::MonPreview()
		:IGamePatch(globalPatcher->CreateInstance("EraPlugin.ExtendedMonPreviewPanel.daemon_n"))
	{
