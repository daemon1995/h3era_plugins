    ...
    public IGamePatch
{
    ...
    static char __stdcall AdvMgr_DrawMap(HiHook* h, H3AdventureManager* advMan, const __int16 mapX, const __int16 mapY, const __int16 mapZ, const int hotSeat, char updateInfoPanel);
