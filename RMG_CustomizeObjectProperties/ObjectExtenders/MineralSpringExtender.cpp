...
BOOL MineralSpringExtender::SetAiMapItemWeight(H3MapItem *mapItem, const H3Hero *hero, const H3Player *player,
                                               int &aiMapItemWeight) const noexcept
{
    ...
    //        }
            ...
            //{
                ...
                aiMapItemWeight = (Army_Get_AI_Value * (SumOfPrimarySkills + 40) / 40) * v9 + (MOVE_POINTS_GIVEN / 2);
            //}
        }
