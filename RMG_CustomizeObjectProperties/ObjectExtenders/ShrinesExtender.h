...
class ShrinesExtender : public extender::ObjectExtender
{
  ...
  protected:
    ...
    virtual H3RmgObjectGenerator *CreateRMGObjectGen(const extender::RMGObjectProperties &objectInfo,
                                                     const BOOL isPseudoGeneration) const noexcept override final;
    ...
    virtual BOOL RMGDlg_ShowCustomObjectHint(const H3ObjectAttributes &attributes,
                                             H3String &defaultText) noexcept override final;
