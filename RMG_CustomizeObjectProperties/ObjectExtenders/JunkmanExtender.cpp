...
BOOL JunkmanExtender::SetAiMapItemWeight(H3MapItem *mapItem, const H3Hero *hero, const H3Player *player,
                                        int &aiMapItemWeight) const noexcept
{
    // TODO: look at: AI town manager (or visiting) - art merchant
