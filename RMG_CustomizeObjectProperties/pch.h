...
//	3.2 objectsToAddInRmgList is actuallyabout objects extensios adds new objects and allows generation if data is properly set;
//	3.3 display data from default.exe/json files
//	3.4 
